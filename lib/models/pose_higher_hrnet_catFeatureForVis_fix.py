...
class PoseHigherResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        # self.feature_deconv_layer = nn.Sequential(
        #         nn.ConvTranspose2d(
        #             in_channels=32,
        #             out_channels=32,
        #             kernel_size=4,
        ...
        #     )
        self.final_layers_vis = nn.Conv2d(
            in_channels=32+14+14,
            out_channels=8,
            kernel_size=1,
            stride=1,
            padding=0
    ...
    def forward(self, x):
        ...
        merge_feature = torch.cat((all_point_heatmaps_and_tags, early_feature), 1)
        y = self.final_layers_vis(merge_feature)
        final_outputs.append(y)
